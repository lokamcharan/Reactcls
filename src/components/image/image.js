...
render(){
    ...
    return (
        <>
        <button className="imgage1" onClick={this.handleImageChange}>{this.state.isChanged ? this.state.message2:this.state.message1}</button><br/><br/>
        
        <img src={imgSrc} alt="New Year"/>
        {
           <h2>
           Image Changed to {this.state.isChanged ? "Second" : "First"}
         </h2>
        }
        <br></br>
        <hr></hr>
